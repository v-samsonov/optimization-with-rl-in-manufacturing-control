...
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.common.policies import BasePolicy, nature_cnn, register_policy
    ...
    def step(self, obs, state=None, mask=None, deterministic=True, action_mask=None):
        ...
        if action_mask is not None:
            if len(action_mask) != 0:
                sh_size = len(action_mask)
                feed_dict[self.action_mask_ph] = self.prepare_action_mask(action_mask).reshape(1, sh_size)
