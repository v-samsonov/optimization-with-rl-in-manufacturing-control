...
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking import logger, deepq
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.common import tf_util as tf_util_mod, OffPolicyRLModel as OffPolicyRLModel_mod, SetVerbosity, TensorboardWriter
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.common.vec_env import VecEnv
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.common.schedules import LinearSchedule
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.deepq.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.deepq.policies import DQNPolicy as DQNPolicy_mod
from RL_Code.modules.agents.stable_baselines2_action_filtering.sb2_mod_code.action_masking.a2c.utils import total_episode_reward_logger


class DQN(OffPolicyRLModel_mod):
    """
    The DQN model class.
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
        ...
        super(DQN, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose, policy_base=DQNPolicy_mod,
    ...
    def setup_model(self):
        ...
        with SetVerbosity(self.verbose):
            ...
            assert issubclass(test_policy, DQNPolicy_mod), "Error: the input policy for the DQN model must be " \
                                                       "an instance of DQNPolicy."

            self.graph = tf.Graph()
            with self.graph.as_default():
                self.set_random_seed(self.seed)
                self.sess = tf_util_mod.make_session(num_cpu=self.n_cpu_tf_sess, graph=self.graph)
                ...
                self.params = tf_util_mod.get_trainable_vars("deepq")

                # Initialize the parameters and copy them to the target network.
                tf_util_mod.initialize(self.sess)
