...
from RL_Code.modules.agents.stable_baselines2_action_filtering.dqn_modified import DQNModified
from RL_Code.modules.agents.stable_baselines2_action_filtering.noise_factory import ActionNoiseConstructor
from RL_Code.modules.agents.stable_baselines2_action_filtering.policy_constructor import assemble_policy_kwargs, build_policy
from RL_Code.modules.agents.stable_baselines2_action_filtering.sac_modified import SACModified
from RL_Code.modules.agents.stable_baselines2_action_filtering.vectorize_environment import vectorize_env_stb2

RL_ALGOS = {
    'stable_baselines2_action_masking':
        {'sac': SACModified,
         'dqn': DQNModified
         }
}
...
class AgentConstructor(AgentConstructorInterface):
    ...
    def build(self, rl_algorithm_tag, environment, rnd_seed, tebsorboard_path,
        ...
        if action_noise is None:
            return RL_ALGOS['stable_baselines2_action_masking'][rl_algorithm_tag](policy=policy_type,
