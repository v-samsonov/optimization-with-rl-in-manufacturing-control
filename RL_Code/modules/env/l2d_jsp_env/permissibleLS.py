...
def permissibleLeftShift(a, durMat, mchMat, mchsStartTimes, opIDsOnMchs, high):
    ...
    if len(possiblePos) == 0:
        startTime_a = putInTheEnd(a, jobRdyTime_a, mchRdyTime_a, startTimesForMchOfa, opsIDsForMchOfa, high)
    else:
...
def putInTheEnd(a, jobRdyTime_a, mchRdyTime_a, startTimesForMchOfa, opsIDsForMchOfa, high):
