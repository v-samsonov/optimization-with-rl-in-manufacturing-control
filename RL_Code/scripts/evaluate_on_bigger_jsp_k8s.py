...
if __name__ == "__main__":
    ...
    datestamp_run = os.environ.get('DATE_STAMP')
    ...
    # get related runs
    agent_path_lst, exp_alias_lst = get_agents_from_wandb(filt_dicts, wandb_project, rand_seed, wandb_entity)
    ...
    experiment_eval_pretrained_agents(agent_paths=agent_path_lst, exp_alias_lst=exp_alias_lst,
                                      date_stamp=datestamp_run, jsp_eval_lst=jsp_eval_lst, wandb_logs=True,
                                      wandb_entity=wandb_entity, wandb_project=wandb_project,  **run_config_pars)
